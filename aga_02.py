...
def reconstruct_image(uploaded_image):
    ...
    return noisy_img[0], reconstructed_img[0]

def display_images(noisy_img, reconstructed_img):
...
noisy_img, reconstructed_img = reconstruct_image(uploaded_image)
display_images(noisy_img, reconstructed_img)
